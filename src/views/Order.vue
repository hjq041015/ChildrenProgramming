                        ...
                        <div class="client-address-area">
                            <div class="row">
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <input type="text" v-model="order.company" class="form-control" id="comName"
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <input type="text" v-model="order.street1"
                                           class="form-control" id="address" placeholder="" required="">
                                </div>

                                <div class="col-12 mb-4">
                                    <input type="text" v-model="order.street2"
                      ...
                      <span class="product-list-single">
                        ...
                        <div>
                          ...
                          <div>x{{ item.count }}</div>
                                        ...
                                        <li class="order-price"><span>商品合计</span> <span class="pur-price">￥{{
                                                total
                                            }}</span></li>
                                        <li class="order-price"><span>付款金额</span> <span
                                            class="pur-price">￥{{ (total * 1.08375).toFixed(2) }}</span></li>
                                    </ul>
                                    ...
                                    <div class="pay-policy-des">
                                        <p>
                                            您的个人数据将用于处理您的订单，支持您在本网站的体验，以及用于我们隐私政策中描述的其他目的</p>
                                    </div>
                                    <div class="post-btn-area">
                                        <button type="submit" @click="createOrder" class="auth-btn post">确认订单
                                        </button>
                                    </div>
                                </div>
                            </div>
