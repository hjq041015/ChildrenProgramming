  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="联系方式2" prop="contact2">
        <el-input
          v-model="queryParams.contact2"
          placeholder="请输入联系方式2"
          clearable
          @keyup.enter="handleQuery"
        />
      </el-form-item>
      <el-form-item label="联系方式3" prop="contact3">
        <el-input
          v-model="queryParams.contact3"
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="teacherRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="联系方式2" prop="contact2">
          <el-input v-model="form.contact2" placeholder="请输入联系方式2" />
        </el-form-item>
        <el-form-item label="联系方式3" prop="contact3">
          <el-input v-model="form.contact3" placeholder="请输入联系方式3" />
        </el-form-item>
      </el-form>
      <template #footer>
