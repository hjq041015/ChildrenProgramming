<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="课程数量" prop="lessone">
        <el-input
          v-model="queryParams.lessone"
          placeholder="请输入课程数量"
          clearable
          @keyup.enter="handleQuery"
        />
      ...
      <el-form-item label="最大学生" prop="maxStudents">
        <el-input
    ...
    <el-table v-loading="loading" :data="courseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课程详细" align="center">
        <template #default="{ row }">
          <div class="line-limit-3">
            {{ row.description }}
          </div>
      ...
      <el-table-column label="课程数量" align="center" prop="lessone" />
      <el-table-column label="课程价格" align="center" prop="price" />
      <el-table-column label="课程时长" align="center" prop="duration" />
      <el-table-column label="最大学生" align="center" prop="maxStudents" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="courseRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="课程详细" prop="description">
          <el-input v-model="form.description" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="课程数量" prop="lessone">
          <el-input v-model="form.lessone" placeholder="请输入课程数量" />
        </el-form-item>
        <el-form-item label="课程价格" prop="price">
        ...
        <el-form-item label="最大学生" prop="maxStudents">
          <el-input v-model="form.maxStudents" placeholder="请输入最大学生" />
        </el-form-item>
      </el-form>
      <template #footer>
