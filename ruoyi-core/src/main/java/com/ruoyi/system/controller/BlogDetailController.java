...
public class BlogDetailController extends BaseController
{
    ...
    @Log(title = "博客详情表", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, BlogDetail blogDetail)
    {
        ...
        util.exportExcel(response, list, "博客详情表数据");
    }
    ...
    @Log(title = "博客详情表", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "博客详情表", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "博客详情表", businessType = BusinessType.DELETE)
	@DeleteMapping("/{ids}")
